...
export default function NotFound() {
  return (
    ...
    >
      <Telescope size={30} style={{ color: "oklch(0.5 0.2 264)" }} />
      <p className="label-mono mt-3 mb-1">Lost in the dark</p>
      <h1 className="text-2xl mb-2 glow-text-gold" style={{ color: "oklch(0.22 0.02 280)" }}>
        404 — Off the map
      </h1>
      <p className="text-sm mb-6" style={{ color: "oklch(0.46 0.02 280)" }}>
